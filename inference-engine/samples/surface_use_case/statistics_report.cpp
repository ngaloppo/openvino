...
void StatisticsReport::dump() {
    CsvDumper dumper(true, _config.report_folder + _separator + "surface_use_case_report.csv");
...
void StatisticsReport::dumpPerformanceCounters(const std::vector<PerformaceCounters> &perfCounts) {
    ...
    CsvDumper dumper(true, _config.report_folder + _separator + "surface_use_case_" + _config.report_type + "_report.csv");
