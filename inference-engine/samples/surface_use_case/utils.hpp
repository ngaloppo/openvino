...
size_t getBatchSize(const surface_use_case::InputsInfo& inputs_info);
...
template <typename T>
surface_use_case::InputsInfo getInputsInfo(const std::string& shape_string,
    ...
    surface_use_case::InputsInfo info_map;
    for (auto& item : input_info) {
        surface_use_case::InputInfo info;
