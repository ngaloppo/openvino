...
TEST(fully_connected_gpu, b_fs_yx_fsv4)
{
    ...
    auto bias_gold = engine.allocate_memory({data_types::f32, format::bfyx, {1, 1, in_F, 1}});
    auto bias_imad = engine.allocate_memory({data_types::f32, format::bfyx, {1, 1, in_F, 1}});
